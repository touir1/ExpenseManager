...
const BACKEND_KEYS: Record<string, string> = {
  ...
  INVALID_USERNAME_OR_PASSWORD:       'apiErrors.invalidUsernameOrPassword', // NOSONAR
  NO_ASSIGNED_ROLE:                   'apiErrors.noAssignedRole',
  EMAIL_VERIFICATION_FAILED:          'apiErrors.emailVerificationFailed',
  NOT_MATCHING_CONFIRM_PASSWORD:      'apiErrors.notMatchingConfirmPassword', // NOSONAR
  SET_NEW_PASSWORD_FAILED:            'apiErrors.setNewPasswordFailed',       // NOSONAR
  REQUEST_PASSWORD_RESET_FAILED:      'apiErrors.requestPasswordResetFailed', // NOSONAR
  RESET_PASSWORD_FAILED:              'apiErrors.resetPasswordFailed',        // NOSONAR
  MISSING_TOKEN:                      'apiErrors.missingToken',
  INVALID_TOKEN:                      'apiErrors.invalidToken',
  CREATE_PASSWORD_FAILED:             'apiErrors.createPasswordFailed',       // NOSONAR
