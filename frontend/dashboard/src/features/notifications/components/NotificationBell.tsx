...
export default function NotificationBell() {
  ...
  useEffect(() => {
    if (unreadCount > prevCountRef.current && notifications[0]) {
      ...
      if (n.type === 'FAMILY_MEMBER_REMOVED') {
        show(
          t('notifications.familyMemberRemoved', {
            removedByName: n.payload.removedByName,
            familyName: n.payload.familyName,
            expenseCount: n.payload.expenseCount,
          }),
          'info',
        )
      }
