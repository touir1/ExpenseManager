    ...
    <div className="relative" ref={containerRef}>
      ...
      {open && (
        ...
        >
            ...
            {isLoading && notifications.length === 0 ? (
              ...
              notifications.map(n => (
                <button
                  ...
                  className={`w-full flex items-start gap-2.5 text-left px-3 py-2.5 border-b border-surface-border last:border-b-0 hover:bg-surface-subtle transition-colors duration-100 cursor-pointer ${!n.isRead ? 'bg-brand-soft' : ''}`}
                >
          ...
          {/* Footer */}
          <div className="px-3 py-2 border-t border-surface-border text-center">
            <Link
              to="/notifications"
