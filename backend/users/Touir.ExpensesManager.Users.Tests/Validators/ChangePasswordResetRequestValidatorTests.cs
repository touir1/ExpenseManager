...
{
    public class ChangePasswordResetRequestValidatorTests
    {
        private readonly ChangePasswordResetRequestValidator _validator = new();
        ...
        {
            var result = _validator.TestValidate(new ChangePasswordResetRequest { Email = "john@doe.com", VerificationHash = "hash", NewPassword = "newPassword1" });
